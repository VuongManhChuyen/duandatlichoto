<footer class="text-center lg:text-left bg-gray-100 text-gray-600">
    ...
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="">
        <h6 class="uppercase
            ...
            md:justify-start
          ">
          <img src="./content/img/logo.png" alt="" class="w-[200px]">
        
        </h6>
        <p class="mb-4">
          <a href="#!" class="text-gray-600">CÔNG TY THƯƠNG MẠI VÀ DỊCH VỤ VINFAST</a>
        </p>
        <img src="./content//img//bo-cong-thuongaa-600x227.png" alt="" class="w-[150px]">
      </div>
      <div class="">
  ...
  <div class="text-center p-6 bg-gray-200">
    ...
    <a class="text-gray-600 font-semibold" href="#">Vuong Duc Xuat</a>
  </div>
</footer>
</body>

...
<section>
  <div class="slideshow-container">
    <div class="mySlides fade">
      ...
      <img src="image/slider.png" class="w-[100%] h-[100%]">
...
<article class="content mx-auto">
  <h1 class="product_sale py-[20px] mt-[20px] text-[red] pl-[25px] text-center font-bold text-[50px]">Top 05 sản phẩm ưu
    thích</h1>
  ...
  <div class="">
    ...
    <!-- Top 5 sản phẩm yêu thích -->
          <div class="w-[300px] h-[400px] bg-gray-800 rounded-lg dark:border-gray-300 shadow-2xl">
            <a href="/chitiet-sp?id=<?=$sanpham->id_sanpham?>">
              <img class="p-4 rounded-t-lg w-full" src="image/<?=$sanpham->img_sanpham?>" alt="product image" />
            </a>
            <div class="px-5 pb-5">
              <a href="/chitiet-sp?id=<?=$sanpham->id_sanpham?>&id_danhmuc=<?=$sanpham->id_danhmuc?>">
                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                <?=$sanpham->name_sanpham?>
                  </h5>
              </a>
              ...
              <div class="my-5"><span
                  class="text-xl font-bold text-gray-900 dark:text-white"><?=$sanpham->price_sanpham?> VNĐ</span>
              </div>
...
<main style="padding: 0px 30px;">
  ...
  <div class="flex">
    ...
    <article class="w-[80%] ">
      ...
      <h1 class="text-right text-[blue]">Xem Thêm <i class="fa-solid fa-arrow-right"></i></h1>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-[15px]" style="padding: 10px 20px;">
     <?php foreach ($sanphammoi as $sanphammoi):?>
        <div class="shadow-2xl product " style="padding: 20px 25px;">
      <a href="../ASM/View/chitietsp.php">    <img class="w-[280px] h-[210px]" src="image/<?=$sanphammoi->img_sanpham?>"> </a>
        <p class="font-bold text-[20px] text-center mt-[10px]">
          <?=$sanphammoi->name_sanpham?>
        </p>
        ...
        <div class="text-center">
          ...
          <?=$sanphammoi->price_sanpham?> VNĐ
          </p>
        </div>

        <div class="flex items-center justify-center my-[30px] gap-[40px]">
          <button style="transition: 0.5s;"
            class="bg-[black] px-[20px] py-[5px] text-white font-bold border-[black] border border-[3px] hover:bg-[white] hover:text-[black] "><a href="/chitiet-sp?id=<?=$sanphammoi->id_sanpham?>">Xem Chi Tiết</a></button>

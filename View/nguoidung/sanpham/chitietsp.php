...
<body>
      ...
      <div class="text-[20px] hidden md:block md:flex md:items-center md:gap-[25px]">
        ...
        <div class=" dropdown ">
          ...
          <div class="dropdown-content ">
            <a href="/lichhentk?id=<?= $_SESSION["auth"]->id_taikhoan?>">
  ...
  <div class="flex">
    <aside class="w-[20%]  hidden md:block">
      <div class="shadow-2xl">
        ...
        <div class="">
          ...
          <a href="#"> <p style="transition: 0.5s;" class="py-[5px] pl-[10px] hover:bg-[black] hover:text-white cursor-pointer">
    ...
    <article class="w-[80%] ">
       ...
       <img class="w-[500px] "src="image/<?=$sanpham2->img_sanpham?>">
        <div>
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <?=$sanpham2->price_sanpham?> VNĐ
            </h1>
              
              <!-- <a href="/add-lichhen"> -->
                <button id="myBtn"
              class="bg-[black] text-white px-[25px] py-[7px] mt-[20px] rounded hover:bg-[white] hover:text-[black] hover:border-[1px] hover:border-[black] duration-700">Đặt
              Lịch
          </button>
          <!-- </a> -->
          <?php
          if (isset($_SESSION['auth'])):
           ...
           ?>      
            <div id="myModal" class="modal">
              <!-- Modal content -->
              <form action="add-lichhen" method="post">
                <div class="modal-content">
                  <span class="close">&times;</span>
                  <h1 class="text-center text-[40px] font-bold">Đặt Lịch</h1>
                  <div class="mt-[20px]" style="padding: 0px 50px;">
                    <div>
                      ...
                      <div class="my-[20px]">
                        <input name="id_taikhoan"
                          ...
                          type="text" value="<?php echo $_SESSION["auth"]->id_taikhoan ?>" >
                        ...
                        <input name=""
                          ...
                          type="text" value="<?php echo $_SESSION["auth"]->name_taikhoan ?>" readonly>


                        <label class="ml-[60px]" for="">Số Điện Thoại</label>
                        <input name=""
                          class="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none "
                          type="text" value="<?php echo $_SESSION["auth"]->phone_taikhoan ?>" readonly>
                        <label class="ml-[60px]" for="">Email</label>
                        <input name=""
                          class="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none "
                          type="text" value="<?php echo $_SESSION["auth"]->email_taikhoan ?>" readonly>
                      </div>
                    </div>
                    <div>
                      <h1 class="text-[25px]" style="font-family: Arial, Helvetica, sans-serif;">Lựa chọn thời gian</h1>
                      <div class="my-[20px]">
                        <label for="" class="ml-[20px]">Ngày</label>
                        <input name="date_lichhen"
                          class=" border border-gray-200 py-3 px-4 pr-8 rounded leading-tight focus:outline-none "
                          type="date" required>
                        <small style="color: red;"><?php if (isset($_SESSION['btn_insert_lichhen']['date_lichhen'])) :?>
                          <?= $_SESSION['btn_insert_lichhen']['date_lichhen'] 
                                                 ?>
                          <?php endif ?></small>

                        <label for="" class="ml-[30px]">Khung Giờ</label>
                        <input name="hours_lichhen"
                          class=" border border-gray-200 py-3 px-4 pr-8 rounded leading-tight focus:outline-none"
                          type="time" id="" required>
                        <small
                          style="color: red;"><?php if (isset($_SESSION['btn_insert_lichhen']['hours_lichhen'])) : ?>
                          <?= $_SESSION['btn_insert_lichhen']['hours_lichhen'] ?>
                          <?php endif ?></small>
                    ...
                    <div>
                      <h1 class="text-[25px]" style="font-family: Arial, Helvetica, sans-serif;">Tên Xe</h1>
                      <input type="hidden"name="id_sanpham"value="<?=$sanpham2->id_sanpham?>">
                      <input
                        ...
                        type="text" name="" value="<?=$sanpham2->name_sanpham?>" readonly>
                    </div>
                    
                    
                    <div>
                      
                      <h1 class="text-[25px]" style="font-family: Arial, Helvetica, sans-serif;">Địa Chỉ</h1>
                      <select name="id_diachi"
                    class="border border-gray-200 py-3 px-4 pr-8 rounded leading-tight focus:outline-none ">
                    <option value="0" selected>Chọn Địa Chỉ</option>
                    <?php foreach ($diachi as $diachi) :?>
                    
                    <option value="<?=$diachi->id_diachi?>"> <?=$diachi->name_diachi?> </option>'; 
                      <?php endforeach; ?>
                  </select>
                      
                    </div>
                    <div>
                      <h1 class="text-[25px]" style="font-family: Arial, Helvetica, sans-serif;">Yêu Cầu Khác</h1>
                      <input type="text" name="description_lichhen"
                        class="border border-gray-200 py-3 px-4 pr-8 rounded leading-tight focus:outline-none ">
                      </input>
                    </div>
            ...
            <?php else : ?>
              ...
              <div class="modal-content ">
                <span class="close">&times;</span>
                <p><a href="/dangnhap">Vui Lòng Đăng Nhập !</a> </p>
              </div>
      ...
      <div class="shadow-2xl text-center">
        ...
        <p style="padding: 20px 40px;"><?=$sanpham2->description_sanpham?></p>
      </div>
  ...
  <div class="w-[80%] mx-auto py-10">
    <h1 class="text-center py-5 text-[22px] font-[500]">SẢN PHẨM HOT</h1>
    <div class=" gap-[20px] grid grid-cols-4">
      <?php foreach ($sanpham3 as $sanpham3):?>
     <div class="shadow-2xl " style="padding: 10px 30px;">
                <a href="/chitiet-sp?id=<?=$sanpham3->id_sanpham?>">
                    <div class="">
                        <div class="w-[250px]">
                            <img class="" src="image/<?=$sanpham3->img_sanpham?>" alt="">
                        </div>
                        <div class="text-center ">
                            <p class="text-[15px] font-[400] cursor-pointer text-[30px]"><?=$sanpham3->name_sanpham?></p>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="">
                                <p class="text-[17px] text-[red] font-bold"><?=$sanpham3->price_sanpham?> vnđ</p>
                            </div>
                            <div>
                                <button class="bg-[black] text-white px-[10px] py-[3px] rounded">Chi tiết</button>
                            </div>
                        </div>
                    </div>
                </a>

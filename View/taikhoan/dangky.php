...
<div class="flex items-center justify-center  bg-gray-100">
  <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
    <div class="flex justify-center">
      <img src="./content//img//logo.png" alt="" class="w-[100px]">
    </div>
    <?php
...
?>
    ...
    <form action="/dangky-user" method="POST">
      <div class="mt-4">
        <div>
        ...
        <div class="flex">
          <button class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900" type="submit">Đăng Ký</button>
        </div>
        <div class="mt-6 text-grey-dark">
          Bạn đã có tài khoản ?
          <a class="text-blue-600 hover:underline" href="/dangnhap">
            Đăng Nhập
          </a>
        </div>
      </div>

        ...
        <ul id="menu"
         ...
         <!-- <div class="subnav">
          ...
          <div class="text-[20px] md:hidden text-white">
            <a href="/dangky"> <i class="fa-solid fa-user "><span class="pl-[15px]">Tài
...
<div class="flex items-center justify-center bg-gray-100">
  <div class="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
    ...
    <form action="/dangnhap-user" method="POST" enctype="multipart/form-data">
      <div class="mt-4">
        <div>
        ...
        <div class="flex">
          <button class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900" type="submit">Đăng Nhập</button>
        </div>
        <div class="mt-6 text-grey-dark">
          Bạn chưa có tài khoản ?
          <a class="text-blue-600 hover:underline" href="/dangky">
            Đăng Ký Tài Khoản
          </a>
        </div>
        <div class="mt-6 text-grey-dark">
          <a class="text-blue-600 hover:underline" href="/quenmatkhau">
           Quên Mật Khẩu
          </a>
        </div>
      </div>

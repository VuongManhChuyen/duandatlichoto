      ...
      <div class="text-[20px] hidden md:block md:flex md:items-center md:gap-[25px]">
        ...
        <div class=" dropdown ">
          ...
          <div class="dropdown-content ">
            ...
            <a href="/edit_taikhoan?id=<?= $_SESSION["auth"]->id_taikhoan?>">
        ...
        <div class="mt-4">
          <label class="block">Mật Khẩu<label>
              <input type="password" placeholder="Password" name="pass_taikhoan	"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                value="<?=$_SESSION['auth']->pass_taikhoan?>">
        </div>
        <div class="mt-4">
          <label class="block" for="email">Email<label>
              <input type="text" placeholder="Email" name="email_taikhoan"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                value="<?=$_SESSION['auth']->email_taikhoan?>">
        </div>
        ...
        <div class="mt-4">
          <label class="block">Số Điện Thoại<label>
              <input type="text" placeholder="Số điện thoại" name="phone_taikhoan"
                class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600"
                value="<?=$_SESSION['auth']->phone_taikhoan?>">
        </div>

        <div class="flex">
          
          <button class="w-full px-6 py-2 mt-4 text-white bg-blue-600 rounded-lg hover:bg-blue-900" type="submit">Cập Nhật</button>
        </div>
      </div>
    </form>
